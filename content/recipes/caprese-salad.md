...
servings: 4
difficulty: 'easy'
image: 'https://images.unsplash.com/photo-1595587870672-c79b47875c6a?q=80&w=1946&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
imageAlt: 'Caprese salad with tomatoes, mozzarella, and basil'
ingredients:
  - '4 large ripe tomatoes (preferably heirloom or beefsteak)'
  - '16 oz fresh mozzarella cheese (buffalo mozzarella if available)'
...
instructions:
  - title: 'Slice'
    steps:
      - text: 'Slice tomatoes into 1/4-inch thick rounds. Pat dry with paper towels to remove excess moisture.'
      - text: 'Slice mozzarella into 1/4-inch thick rounds, similar in size to the tomato slices.'
      - text: 'Pick whole basil leaves, keeping them intact. Wash and pat dry gently.'
  - title: 'Arrange'
    steps:
      - text: 'On a large serving platter, alternate tomato slices and mozzarella slices in an overlapping pattern.'
      - text: 'Tuck fresh basil leaves between the slices for visual appeal.'
      - text: 'You can create a circular pattern, straight line, or any artistic arrangement you prefer.'
  - title: 'Dress and Season'
    steps:
      - text: 'Drizzle extra virgin olive oil generously over the arranged salad.'
      - text: 'Drizzle balsamic glaze in a decorative pattern across the top.'
      - text: 'Sprinkle with flaky sea salt and freshly ground black pepper.'
      - text: 'Let sit for 5 minutes before serving to allow flavors to meld.'
        timer: 300
tags:
  - 'italian'
  - 'salad'
...
**Balsamic glaze**: Thick, syrupy reduction - easiest to drizzle
**Aged balsamic**: Expensive but incredible - use sparingly
**Regular balsamic**: Too thin and acidic - reduce it first or skip it
...
![Caprese presentation styles](https://images.unsplash.com/photo-1572695157366-5e585ab2b69f?auto=format&fit=crop&w=1000&q=80)
...
**Wine**: Crisp Italian whites like Pinot Grigio, Vermentino, or Soave
**Bread**: Crusty Italian bread or focaccia for soaking up juices
**Protein**: Prosciutto, grilled chicken, or seared tuna
**Other Antipasti**: Olives, roasted red peppers, marinated artichokes
