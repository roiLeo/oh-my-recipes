...
instructions:
  - title: 'Prepare the Vegetables'
    steps:
      - text: 'Cut tomatoes into large wedges. Slice cucumber into thick half-moons.'
      - text: 'Thinly slice the red onion. If you find raw onion too strong, soak slices in cold water for 10 minutes, then drain.'
      - text: 'Slice the bell pepper into rings, removing seeds and membranes.'
  - title: 'Assemble the Salad'
    steps:
      - text: 'In a large serving bowl or platter, arrange tomatoes, cucumbers, bell pepper, and onion.'
      - text: 'Scatter Kalamata olives over the vegetables.'
      - text: 'Place the feta cheese block on top in the center (traditional style) or crumble it over the salad.'
  - title: 'Dress and Serve'
    steps:
      - text: 'Drizzle extra virgin olive oil generously over the salad.'
      - text: 'Sprinkle with red wine vinegar.'
      - text: 'Season with dried oregano, salt, and black pepper.'
      - text: 'Toss gently just before serving, or serve as is and let diners mix their own.'
      - text: 'Garnish with fresh oregano if available.'
tags:
  - 'greek'
  - 'salad'
  - 'mediterranean'
