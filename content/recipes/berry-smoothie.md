...
description: "A refreshing and healthy smoothie packed with mixed berries, banana, and yogurt. A great way to start the day."
...
servings: 1
difficulty: 'easy'
image: 'https://images.unsplash.com/photo-1553530979-7ee52a2670c4?auto=format&fit=crop&w=1200&q=80'
imageAlt: 'Purple berry smoothie in a glass'
ingredients:
...
instructions:
  - title: 'Blend'
    steps:
      ...
      - text: 'Blend on high until smooth and creamy. Add more liquid if too thick.'
        timer: 10
  - title: 'Serve'
    steps:
      - text: 'Pour into a tall glass and garnish with fresh mint.'
tags:
  - 'smoothie'
  - 'healthy'
  - 'breakfast'
...
*Fresh berries are the star of this show.*
